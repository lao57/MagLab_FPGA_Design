...
#
# Script generated by Vivado on Wed Mar 25 14:20:27 -0400 2026
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Code/SeniorDesign/SeniorDesign/MAGLAB_PYNQ/MAGLAB_PYNQ.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
