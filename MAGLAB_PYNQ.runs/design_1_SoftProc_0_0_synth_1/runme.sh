...
HD_PWD='C:/Code/SeniorDesign/SeniorDesign/MAGLAB_PYNQ/MAGLAB_PYNQ.runs/design_1_SoftProc_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_SoftProc_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_SoftProc_0_0.tcl
